...
actions.aliases = {
  _goto_file_selection        = '_select',
  goto_file_selection_edit    = 'select',
  goto_file_selection_split   = 'hselect',
  goto_file_selection_vsplit  = 'vselect',
  goto_file_selection_tabedit = 'tabselect',

  -- there's probably a better way to do this
  -- we need to be able to go both ways for compatibility
  _select   = '_goto_file_selection',
  select    = 'goto_file_selection_edit',
  hselect   = 'goto_file_selection_split',
  vselect   = 'goto_file_selection_vsplit',
  tabselect = 'goto_file_selection_tabedit',
}
